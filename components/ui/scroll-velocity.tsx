  ...
  (
    ...
    return (
      ...
      >
        ...
        {/* 左侧模糊遮罩 */}
        <div className="absolute left-0 top-0 h-full w-20 bg-gradient-to-r from-white via-white/80 to-transparent dark:from-gray-950 dark:via-gray-950/80 pointer-events-none z-10" />

        {/* 右侧模糊遮罩 */}
        <div className="absolute right-0 top-0 h-full w-20 bg-gradient-to-l from-white via-white/80 to-transparent dark:from-gray-950 dark:via-gray-950/80 pointer-events-none z-10" />
      </div>
    );
  }
);

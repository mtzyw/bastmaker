-- AI domain schema migration (mirrors data/12、ai_schema.sql)
-- Flexible, minimal constraints; intended for Supabase CLI `db push`.
...
-- credit_logs.related_job_id (soft reference)
DO $$
BEGIN
  IF NOT EXISTS (

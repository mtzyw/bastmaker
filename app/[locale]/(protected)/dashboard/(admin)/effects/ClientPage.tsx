...
import { EffectFormDialog } from './EffectFormDialog';
import {
  Table,
  TableBody,
  TableCell,
...
export const EffectsPageClient = ({ initialEffects }: { initialEffects: any[] }) => {
  ...
  return (
    <div className="container mx-auto p-4 md:p-6">
      ...
      <EffectFormDialog isOpen={isDialogOpen} onOpenChange={setIsDialogOpen} effectToEdit={effectToEdit} />

...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "ImageToImagePage" });
...
export default async function ImageToImagePage() {
  const t = await getTranslations("ImageToImagePage");
...
type ImageToImageSeoContentProps = {
  badgeLabel: string;
...
function ImageToImageSeoContent({
  badgeLabel,
  overviewTitle,
  overviewBody,
  overviewPoints,

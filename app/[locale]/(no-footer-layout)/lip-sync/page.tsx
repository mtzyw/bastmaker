...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "LipSyncPage" });
...
export default async function LipSyncPage() {
  const t = await getTranslations("LipSyncPage");

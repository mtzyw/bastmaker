...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "TextToImagePage" });
...
export default async function TextToImagePage() {
  const t = await getTranslations("TextToImagePage");
...
type TextToImageSeoContentProps = {
  badgeLabel: string;
...
function TextToImageSeoContent({
  badgeLabel,
  overviewTitle,
  overviewBody,
  overviewPoints,

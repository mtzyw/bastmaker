...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "ImageToVideoPage" });
...
export default async function ImageToVideoPage() {
  const t = await getTranslations("ImageToVideoPage");
...
type ImageToVideoSeoContentProps = {
  badgeLabel: string;
...
function ImageToVideoSeoContent({
  badgeLabel,
  overviewTitle,
  overviewBody,
  overviewPoints,
